...
func (m *MockMessageHandler) SendMessage(payload any) error {
	m.ctrl.T.Helper()
...
func (mr *MockMessageHandlerMockRecorder) SendMessage(payload any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMessage", reflect.TypeOf((*MockMessageHandler)(nil).SendMessage), payload)
}
