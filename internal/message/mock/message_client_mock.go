...
// Source: internal/message/message_client.go
//
// Generated by this command:
//
//	mockgen -source=internal/message/message_client.go -destination=internal/message/mock/message_client_mock.go
//
...
func (m *MockMessageQueueClient) Send(exchangeName, exchangeType, queue string, payload []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", exchangeName, exchangeType, queue, payload)
	ret0, _ := ret[0].(error)
	return ret0
}

// Send indicates an expected call of Send.
func (mr *MockMessageQueueClientMockRecorder) Send(exchangeName, exchangeType, queue, payload any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockMessageQueueClient)(nil).Send), exchangeName, exchangeType, queue, payload)
}
