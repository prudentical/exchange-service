...
// Source: internal/service/exchange/exchange_order_service.go
//
// Generated by this command:
//
//	mockgen -source=internal/service/exchange/exchange_order_service.go -destination=internal/service/exchange/mock/exchange_order_service_mock.go
//
...
func (m *MockExchangeOrderService) Buy(exchange sdk.ExchangeSDK, request exchange.OrderRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockExchangeOrderServiceMockRecorder) Buy(exchange, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Buy", reflect.TypeOf((*MockExchangeOrderService)(nil).Buy), exchange, request)
}

// Sell mocks base method.
func (m *MockExchangeOrderService) Sell(exchange sdk.ExchangeSDK, request exchange.OrderRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockExchangeOrderServiceMockRecorder) Sell(exchange, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Sell", reflect.TypeOf((*MockExchangeOrderService)(nil).Sell), exchange, request)
}
