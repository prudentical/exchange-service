...
func (m *MockOrderHandler) Order(c echo.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Order", c)
	ret0, _ := ret[0].(error)
	return ret0
}

// Order indicates an expected call of Order.
func (mr *MockOrderHandlerMockRecorder) Order(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Order", reflect.TypeOf((*MockOrderHandler)(nil).Order), c)
}
